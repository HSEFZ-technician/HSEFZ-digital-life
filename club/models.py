...
class SelectionEvent(models.Model):
    ...
    title          = models.CharField(max_length = 100, blank = False, verbose_name = "selection_title")
...
class EventClassType(models.Model):
    ...
    event_id  = models.ForeignKey(SelectionEvent, verbose_name = "Event Information", on_delete = models.CASCADE)

    type_name = models.CharField(max_length = 30, blank = False, verbose_name = "Class Type Name")

class EventClassTypeConstraints(models.Model):

    event_id = models.ForeignKey(SelectionEvent, verbose_name = "Event Information", on_delete = models.CASCADE)

    type_id1 = models.ForeignKey(EventClassType, verbose_name = "Type 1", on_delete = models.CASCADE, related_name = "EventClassTypeConstraints_type_id1")

    coef_1   = models.IntegerField(verbose_name = "Coefficient for type 1")

    type_id2 = models.ForeignKey(EventClassType, verbose_name = "Type 2", on_delete = models.CASCADE, related_name = "EventClassTypeConstraints_type_id2")
...
class EventClassInformation(models.Model):
    ...
    user_id    = models.ForeignKey(StudentClubData, verbose_name = "Teacher Information", on_delete = models.CASCADE)

    name       = models.CharField(max_length = 200, blank = True, verbose_name = "Class Name")

    desc       = models.CharField(max_length = 200, blank = True, verbose_name = "Class Description")

    max_num    = models.IntegerField(verbose_name = "Max Number of Students of the Class")
    
    full_desc  = models.TextField(verbose_name = "Class Full Description")

    class_type = models.ForeignKey(EventClassType, verbose_name = "Class Type Information", on_delete = models.CASCADE)

    hf_desc    = models.BooleanField(verbose_name = "Whether Class Has Full Description")

    forbid_chs = models.BooleanField(verbose_name = "Forbidden Status")

class StudentSelectionInformation(models.Model):

    info_id = models.ForeignKey(EventClassInformation, verbose_name = "Class Information", on_delete = models.CASCADE)

    user_id = models.ForeignKey(StudentClubData, verbose_name = "Student Information", on_delete = models.CASCADE)

    locked  = models.BooleanField(verbose_name = "Selection Locked Status")

class Notice(models.Model):

    title        = models.CharField(max_length = 50, blank = False, verbose_name = "Notice Title")
